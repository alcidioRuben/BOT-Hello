...
\📥 *${quantidade}MB* enviados para @${numeroLimpo}\n🙏Obrigado @${numeroLimpo}!\n\n📅 Essa é a sua *${hojeCompras}ª* compra de hoje.\n📊 Você é o comprador nº *${posicao}* do grupo.\n📈 total acumulado *${totalCompradoUser}*\n\n🏁 *Corra atrás do topo e ganhe bônus no fim do mês✨*
🥇 Maior comprador: *${maiorCompradorTotalStr}!*`; 
...
const dataHora = formatter.format(agora);
  ...
  await sendSuccessReply(`*Transação concluída com sucesso!*\n\n📱 *Número:* ${numeroLimpo}\n📊 *Megas:* ${quantidade}MB\n📆 *Recebido em:* ${dataHora}\n\n_*Transferência processada correctamente*_`);
  }
};
